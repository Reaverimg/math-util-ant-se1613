 ...
 */
package com.phu.mathutil.controller.main;
...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("This statemant comes from the main() method");
            tryTDDFirst();
...
// và ta nhìn kết quả và ta só sánh với kỳ vọng truaocws đó
//để kkeets luận hàm ổn/tính năng ổn, test case  passed
//                                    test case failed
